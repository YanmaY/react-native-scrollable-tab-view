...
const ScrollableTabView = createReactClass({
  ...
  render() {
    ...
    if (this.props.tabBarActiveTextSize) {
      tabBarProps.activeTextSize = this.props.tabBarActiveTextSize;
    }
    if (this.props.tabBarInactiveTextSize) {
      tabBarProps.inactiveTextSize = this.props.tabBarInactiveTextSize;
    }
